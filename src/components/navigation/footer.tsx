  ...
  return <footer className="bg-[#08070e] my-0 py-[42px]">
      <div className="clay-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Products */}
          <div>
            <h3 className="font-semibold mb-4 text-slate-50">Products</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/domains" className="text-gray-600 hover:text-indigo-600 text-sm">Domains</Link></li>
              <li><Link to="/ssl" className="text-gray-600 hover:text-indigo-600 text-sm">SSL Certificates</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/status" className="text-gray-600 hover:text-indigo-600 text-sm">Status</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/contact" className="text-gray-600 hover:text-indigo-600 text-sm">Contact</Link></li>
              <li><Link to="/legal/privacy" className="text-gray-600 hover:text-indigo-600 text-sm">Privacy Policy</Link></li>
              <li><Link to="/legal/terms" className="text-gray-600 hover:text-indigo-600 text-sm">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Domain Channel. All rights reserved.
          </p>
