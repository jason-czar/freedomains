      ...
      <div className="text-center mb-12">
        ...
        <div className="flex items-center justify-center mt-8 rounded-clay-lg p-1.5 shadow-clay-sm inline-flex bg-[#b2b2b2]/[0.19] my-[40px]">
          <button 
            ...
            className={`px-6 py-2 rounded-clay transition-all ${billingCycle === "monthly" ? "clay-button-primary" : "text-gray-500 hover:bg-gray-800/50"}`}
          >
            Monthly
          </button>
          <button 
            onClick={() => setBillingCycle("yearly")} 
            className={`px-6 py-2 rounded-clay transition-all ${billingCycle === "yearly" ? "clay-button-primary" : "text-gray-500 hover:bg-gray-800/50"}`}
          >
