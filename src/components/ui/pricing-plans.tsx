...
const plans: PricingPlan[] = [
  {
    ...
    color: "bg-clay-mint",
    features: [
      { name: "1 Subdomain", included: true },
      { name: "Basic SSL", included: true },
      { name: "5GB Storage", included: true },
      { name: "Simple Redirect", included: true },
      { name: "Basic Analytics", included: true },
      { name: "Email Support", included: true },
      { name: "Custom Landing Page", included: false },
      { name: "Wildcard DNS", included: false },
    ],
  },
  {
    name: "Professional",
    ...
    popular: true,
    features: [
      { name: "5 Subdomains", included: true },
      { name: "Advanced SSL", included: true },
      { name: "25GB Storage", included: true },
      { name: "Advanced Redirects", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Premium SSL", included: true },
      { name: "100GB Storage", included: true },
      { name: "Advanced Redirects", included: true },
      { name: "Enterprise Analytics", included: true },
      { name: "24/7 Support", included: true },
      { name: "Custom Landing Page", included: true },
      { name: "Wildcard DNS", included: true },
    ],
  },
];
...
const PricingPlans = ({ className }: PricingPlansProps) => {
  ...
  return (
    <div className={`${className} clay-container py-16`}>
      <div className="text-center mb-12">
        ...
        <div className="flex items-center justify-center mt-8 bg-white rounded-clay-lg p-1.5 shadow-clay-sm inline-flex">
          <button
            onClick={() => setBillingCycle("monthly")}
            className={`px-6 py-2 rounded-clay transition-all ${
              billingCycle === "monthly" 
                ? "bg-clay-lavender shadow-clay-button text-indigo-700" 
                : "text-gray-500"
            }`}
          >
            Monthly
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {plans.map((plan) => (
          <div 
            key={plan.name} 
            className={`clay-card relative ${plan.popular ? 'transform -translate-y-4' : ''}`}
          >
            {plan.popular && (
            ...
            <Button 
              className={`mt-8 w-full clay-button ${
                plan.name === "Starter" 
                  ? "bg-clay-mint text-green-700" 
                  : plan.name === "Professional" 
                    ? "bg-clay-lavender text-indigo-700" 
                    : "bg-clay-blue text-blue-700"
              }`}
            >
              Get Started
            </Button>
